...
var removeCart = document.querySelectorAll('.remove-to-cart');
...
function _updateCart() {
  _updateCart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(dish) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return axios.post('/update-cart', dish).then(function (res) {
              cartCounter.innerText = Number(res.data.totalQty) == 0 ? '' : Number(res.data.totalQty);
              new Noty({
                type: 'success',
                timeout: 1000,
...
function removeToCart(_x2) {
  return _removeToCart.apply(this, arguments);
}

function _removeToCart() {
  _removeToCart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(dish) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return axios.post('/remove-cart', dish).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    var dish = JSON.parse(btn.dataset.pizza);
    updateCart(dish);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_wrapper_point"] = self["webpackChunkrealtime_wrapper_point"] || [];
